...
BREW_CASKS="google-chrome keybase rectangles visual-studio-code alfred sublime-text vlc discord google-drive obs docker intellij-idea slack aws-vault spotify firefox steam keepassxc steelseries-exactmouse-tool logitech-g-hub"
...
# BREW (ESSENTIAL)
ESSENTIAL_BREW_PACKAGES="coreutils diff-so-fancy fish node python pyenv vim bat ripgrep fd lsd sd gh dust duf"
