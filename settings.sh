...
# BREW (OPTIONAL)
OPTIONAL_BREW_PACKAGES="python3 wget gpg curl ncdu rsync ack yarn awscli git lolcat nyancat streamlink"
...
FISHERMAN_PACKAGES="rafaelrinaldi/pure jethrokuan/z jbonjean/re-search"
