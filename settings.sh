...
BREW_CASKS="google-chrome keybase rectangles visual-studio-code alfred sublime-text vlc discord google-drive obs docker intellij-idea slack aws-vault spotify firefox steam keepassxc steelseries-exactmouse-tool"
